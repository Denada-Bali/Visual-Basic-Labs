...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' TextBox1
        ' 
        TextBox1.Location = New Point(196, 73)
        ...
        ' TextBox2
        ' 
        TextBox2.Location = New Point(196, 106)
        ...
        Label2.TabIndex = 4
        Label2.Text = "Percentage above avarage:"' 
        ' Form1
        ' 
